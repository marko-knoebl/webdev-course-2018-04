...
class GuestBookEntryHandler(BaseHandler):
    def get(self, entry_id):
        entry = GuestBookEntry.get_by_id(int(entry_id))
        return self.render_template(
            'guestbook-entry.html',
            {'entry': entry}
        )

class GuestBookEditHandler(BaseHandler):
    def post(self, entry_id):
        ...
        return self.render_template('guestbook-edit.html')

class GuestBookDeleteHandler(BaseHandler):
    def post(self, entry_id):
        entry = GuestBookEntry.get_by_id(int(entry_id))
        entry.key.delete()

        return self.render_template('guestbook-delete.html')
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route('/guestbook_entry/<entry_id:\d+>', GuestBookEntryHandler),
    webapp2.Route('/guestbook-edit/<entry_id:\d+>', GuestBookEditHandler),
    webapp2.Route('/guestbook-delete/<entry_id:\d+>', GuestBookDeleteHandler)
], debug=True)
